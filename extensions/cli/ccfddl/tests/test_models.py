...
class TestTimeline:
    def test_from_dict_full(self):
        data = {
            ...
            "decision_deadline": "2025-02-15 23:59:59",
            "comment": "Main",
        }
        ...
        assert timeline.decision_deadline == "2025-02-15 23:59:59"
    ...
    def test_from_dict_minimal(self):
        ...
        assert timeline.decision_deadline is None
    ...
    def test_to_dict(self):
        ...
        assert result["decision_deadline"] == "2025-02-15 23:59:59"
